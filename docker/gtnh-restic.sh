...
GTNH_RESTIC_CACHE_DIR="${GTNH_RESTIC_CACHE_DIR:-/backups/.gtnh-restic-cache}"
...
function gtnhResticEnvironment(){
  ...
  export RESTIC_CACHE_DIR="$GTNH_RESTIC_CACHE_DIR"
}
...
function initializeGTNHresticRepository(){
  ...
  mkdir -p "$GTNH_RESTIC_REPOSITORY" "$GTNH_MANAGER_DIR" "$GTNH_RESTIC_CACHE_DIR"
